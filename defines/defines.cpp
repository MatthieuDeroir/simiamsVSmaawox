...
static vector<vector<Spell*> > spellInitialization()
{
    ...
    //mage spells
    Spell* spell_m_1 = new Spell("Boule de feu", 100, 5, ranges[0]);
    Spell* spell_m_2 = new Spell("Foudroiement", 100, 5, ranges[1]);
    Spell* spell_m_3 = new Spell("Blizzard", 100, 5, ranges[2]);
    Spell* spell_m_4 = new Spell("Raz-de-Marée", 100, 5, ranges[3]);

    //warrior spells
    Spell* spell_w_1 = new Spell("Berzerk", 100, 5, ranges[4]);
    Spell* spell_w_2 = new Spell("Tournoiement de hache", 100, 5, ranges[5]);
    Spell* spell_w_3 = new Spell("Coup de boule", 100, 5, ranges[6]);
    Spell* spell_w_4 = new Spell("Furie sanguinaire", 100, 5, ranges[7]);

    //archer spells
    Spell* spell_a_1 = new Spell("Volée de fleches", 100, 5, ranges[8]);
    Spell* spell_a_2 = new Spell("Tir de précision", 100, 5, ranges[9]);
    Spell* spell_a_3 = new Spell("Coup de dague", 100, 5, ranges[10]);
    Spell* spell_a_4 = new Spell("Fleches enflammées", 100, 5, ranges[11]);
...
vector<Champion*> champInitialization(){
    ...
    Champion* champ_mage = new Champion("Mage", 0, spells[0]);

    Champion* champ_warrior = new Champion("Warrior", 0, spells[1]);

    Champion* champ_archer = new Champion("Archer", 0, spells[2]);
